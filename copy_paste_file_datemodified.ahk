...
While Match_Pos := RegExMatch(D8_2_Cpy, "[0-9]{14}", Match_Result, Match_Pos)
	...
	iF FileExist(D8_TARGET)
		...
		RegWrite, REG_SZ, HKEY_CURRENT_USER\Software\Classes\*\shell\File Admin\shell\copyPaste_mod_date, muiverb, Copy DateModified,
		RegWrite, REG_SZ, HKEY_CURRENT_USER\Software\Classes\*\shell\File Admin\shell\copyPaste_mod_date, Icon, %Copy_Ico%,
	...
	ExitApp
		...
		Else {
			...
			iF !ErrorLevel
				...
				RegWrite, REG_SZ, HKEY_CURRENT_USER\Software\Classes\*\shell\File Admin\shell\copyPaste_mod_date, muiverb, Paste DateModified,
				RegWrite, REG_SZ, HKEY_CURRENT_USER\Software\Classes\*\shell\File Admin\shell\copyPaste_mod_date, Icon, %Paste_ICO%,
				}
			else
				TrayTip, File DateModified, Error %error%
		exit
